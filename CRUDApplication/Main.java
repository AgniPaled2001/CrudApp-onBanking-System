...
//        System.out.println("Student Id is " + obj.getStudId());
		...
		Dboperatins.toAddStudentData(obj);
...
//		s.close();
	...
	public static void toRemoveAStudent() {
		...
		Dboperatins.toRemoveAStudentData(id);
//		input.close();
	}
	...
	public static void toUpdateAStudent() {
		...
		if (Dboperatins.studExists(id)) {
			...
			case 1:
				...
				Dboperatins.toUpdateStudName(name,id);

				break;
			case 2:
				System.out.println("Enter the update email: ");
				String email = input.next();
				Dboperatins.toUpdateStudEmail(email,id);

				break;
			case 3:
				System.out.println("Enter the update Grade: ");
				char grade = input.next().charAt(0);
				Dboperatins.toUpdateStudGrade(grade,id);
				break;
			case 4:
				System.out.println("Enter the update name: ");
				long number = input.nextLong();
				Dboperatins.toUpdateStudNumber(number,id);
				break;
...
//		input.close();
	...
	public static void toDisplayAStudent() {
		HashMap<Integer, StudentClass> studentData1 = Dboperatins.toDisplayStudent();
		System.out.println(
				"-------------------------------------------------------------------------------------------------------");
	...
	public static void toSearchAStudent() {
		...
		int id = input.nextInt();
		if (Dboperatins.studExists(id)) {
			StudentClass studentData = Dboperatins.toGetStudData(id);
